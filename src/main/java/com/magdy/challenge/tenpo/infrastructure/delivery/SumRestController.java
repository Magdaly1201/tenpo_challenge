...
public class SumRestController {
    ...
    public SumResponseDTO sum(@RequestParam(value = "value1", required = true) int value1, @RequestParam(value = "value2", required = true) int value2, @ApiIgnore @RequestAttribute Long userId) throws JsonProcessingException {
        return modelMapper.map(sumEndpoints.operationSumValuesAndPercentage(value1, value2, userId), SumResponseDTO.class);
    }
